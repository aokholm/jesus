...
- (void)receivedMIDINoteOffWithNoteNumber:(NSInteger)noteNumber velocity:(NSInteger)velocity channel:(NSInteger)channel;
- (void)receivedMIDIController:(NSInteger)controller value:(NSInteger)value channel:(NSInteger)channel;
@end
...
- (nonnull instancetype)initWithProperty:(NSString * _Nonnull)property format:(NSString * _Nonnull)format value:(double)value minimum:(double)minimum maximum:(double)maximum color:(NSColor * _Nonnull)color frame:(CGRect)frame callback:(void (^ _Nonnull)(double x))callback OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)mouseDown:(NSEvent * _Nonnull)theEvent;
- (void)mouseDragged:(NSEvent * _Nonnull)theEvent;
- (double)randomize;
